  ...
  return (
    ...
    <div>
      ...
      >
        ...
        <p style={{'text-indent': '2rem'}}>
          Barlow’s original Declaration emphasizes freedom of speech; we believe that this freedom must be accompanied with the freedom to design, 
          govern, and own the environments that speech lives within. 
          The original takes a highly individualistic framing; we believe in the power of the individual alongside mutualism, 
          reciprocity, and collective ownership. 
          The original rejects embodiment; we recognize our digital identities and commitments to be interwoven with existing communities, 
          societies, and relationships in the physical and material world. 
          ...
          <p style={{'text-indent': '2rem'}}> The ontology of this object, and how other related objects can be generated related to it, reflects the ethos of our Declaration.
          ...
          <p style={{'text-indent': '2rem'}}> 
            The diff from the original Declaration is available <a className="underline" href="https://www.interdependence.online/diff/e-bw-AGkYsZFYqmAe2771A6hi9ZMIkWrkBNtHIF1hF2"> here. </a> '
          </p>
          ...
          <p style={{'text-indent': '2rem'}}>
            How we define who contributed to the project depends so heavily on how we conceptualize the borders of our selfhood and how we relate to each other, so we thought it was worth elaborating upon here. 
          </p>
          ...
          <p style={{'text-indent': '2rem'}}> 
            We also owe debts to communities that we are part of, mentors who have taught us, ancestors who have written important texts that have shaped our ways of viewing the world.         
          </p>
          ...
          <p style={{'text-indent': '2rem'}}>
            ...
            than the one enforced by the one we currently inhabit.           
          </p>
