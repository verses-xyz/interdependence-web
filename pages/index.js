  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <h1 className="text-3xl font-bold font-mono mt-20">
        A Declaration of the Interdependence of Cyberspace
        </h1>

        <div className="ml-10 sm:ml-5 lg:ml-20 xl:mx-40 max-w-4xl mt-10 font-serif text-2xl text-left space-y-4">
        <p>
        ...
        <p>
        Your concepts of property, expression, identity, value, and community are insufficient. We believe that from ethics, an expanded definition of rational self-interest, and the commonwealth, our governance will emerge. Our identities may be distributed across many of your jurisdictions. The only law that all our constituent cultures would generally recognize is the practice of reciprocity and mutualism, and the truth of openly verifiable relations and actions.
        </p>

        <p>
        You have today created the Corporate Metaverse, which insults the dreams of past, present, and future citizens of the internet. These dreams must now be born anew in us.
        </p>

        <p>
        Your increasingly obsolete information industries perpetuate themselves in the name of freedom of speech stipulating nothing about freedom of interaction - the ability to chart our own paths, connect however we’d like, dissolve silos of speech and data into interoperable worlds. In the Pluriverse, our minds and our creations can interact and interconnect feely. The global web of care no longer requires your siloed servers and data farms to accomplish. 
        </p>

        <p>
        These centralized, enclosing, extractive measures place us in the same position as those previous lovers of freedom and self-determination who rejected the dominion of unearned, arbitrary power. We must declare our virtual selves immune. We will be distributed across the Planet. 
        </p>
