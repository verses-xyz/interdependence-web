    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen py-4 bg-blue-20">
        ...
        <main className="flex flex-col items-center justify-center w-full flex-1 px-10 md:px-10 sm:px-10 lg:px-20 xl:px-20 text-center">
          ...
          <div className="w-1/2">
            <h1 className="text-4xl font-title m-20 md:mx-1 sm:mx-1 sm:text-4xl md:text-7xl lg:text-7xl xl:text-7xl font-semibold">
              Declaration
              <span className="text-xl block font-light italic m-5 sm:text-2xl md:text-4xl lg:text-4xl xl:text-7xl">of the</span>
